...
:sourcedir: peacetrue-sign-client/src/main/java
:resourcesdir: peacetrue-sign-client/src/main/resources
:testsourcedir: peacetrue-sign-client/src/test/java
:source-highlighter: coderay
:coderay-linenums-mode: inline

签名组件用于为开放接口生成签名并验证签名。
...
dependencies {
    compile 'com.github.peacetrue:peacetrue-sign-client:1.2-RELEASE'
}
----
...
<dependency>
    ...
    <artifactId>peacetrue-sign-client</artifactId>
...
dependencies {
    compile 'com.github.peacetrue:peacetrue-sign-server:1.2-RELEASE'
}
----
...
<dependency>
    <groupId>com.github.peacetrue</groupId>
    <artifactId>peacetrue-sign-server</artifactId>
    <version>1.2-RELEASE</version>
</dependency>
----
