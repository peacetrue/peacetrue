...
/**
 * support for {@link RowBounds}
 *
 * @author xiayx
 */
public class RowBoundsHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {

    public static final String DEFAULT_OFFSET_PARAMETER_NAME = "offset";
    public static final String DEFAULT_LIMIT_PARAMETER_NAME = "limit";
    public static final int DEFAULT_OFFSET_PARAMETER_VALUE = 0;
    public static final int DEFAULT_LIMIT_PARAMETER_VALUE = 10;
